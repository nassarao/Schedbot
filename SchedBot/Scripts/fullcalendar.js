...
fcViews.agenda = {
	...
	defaults: {
		...
		minTime: '007:00:00', //this should be changed based on earliest time business opens in a week
		maxTime: '23:00:00', //this should be changed to be the latest the business is open in a week
